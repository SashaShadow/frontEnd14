...
const Cart = () => {
    ...
    const cartEndpoint = "https://mewing-wax-celestite.glitch.me/api/carrito";
    ...
    const newCart = () => {
        return fetch(`https://mewing-wax-celestite.glitch.me/api/carrito/`, {
            method: 'POST',
    ...
    const deleteCart = (id) => {
        return fetch(`https://mewing-wax-celestite.glitch.me/api/carrito/${id}`, {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'},
